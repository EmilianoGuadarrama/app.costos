...
<div class="dash-index-view">
    <div class="index-panel">
        ...
        <div class="header-section">
            <div><h1>Materiales</h1><p>Catálogo de materiales disponibles con precios y unidades.</p></div>
            <div class="header-actions">
                <button class="btn-filter" type="button"><i class="bi bi-funnel me-1"></i> Filtrar</button>
                <a href="{{ route('materiales.create') }}" class="btn-add-new"><i class="bi bi-plus-circle me-1"></i> Nuevo Material</a>
            </div>
        </div>
        <div class="table-responsive">
            <table class="project-table">
                <thead><tr><th style="width:40%;">Detalle del Material</th><th>Precio</th><th>Unidad</th><th style="text-align:right;">Acciones</th></tr></thead>
                <tbody>
                @forelse(($materiales ?? []) as $material)
                    ...
                    <tr class="project-row">
                        ...
                        <td class="action-cell">
                            ...
                            <button type="button" class="btn-icon-action" title="Eliminar" data-bs-toggle="modal" data-bs-target="#eliminarMatModal{{ $matId }}"><i class="bi bi-trash3"></i></button>
                        </td>
                    </tr>
                ...
                @empty
                    <tr class="project-row"><td colspan="4" class="empty-state">No hay materiales registrados por el momento.</td></tr>
                @endforelse
                </tbody>
            </table>
        </div>
