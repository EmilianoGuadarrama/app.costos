...
@section('content')
    ...
    <div class="page-header">
        <div>
            <h2 class="page-title">Nueva Mano de Obra</h2>
            <p class="page-subtitle">Captura la información general de mano de obra.</p>
        </div>
    ...
    <div class="form-card">
        <form action="{{ Route::has('mano_obra.store') ? route('mano_obra.store') : '#' }}" method="POST" class="form-grid">
            @csrf
