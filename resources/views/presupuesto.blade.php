{{-- resources/views/presupuesto.blade.php --}}
    <!doctype html>
<html lang="es">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Presupuesto | App Precios Unitarios</title>
    ...
    <div class="app-main">
        ...
        <main class="content-area">
            <div class="content-wrap">
                <div class="sheet">
                    <div class="mb-3 fw-semibold">Presupuestos</div>
                    ...
                    <form method="POST" action="#" class="form-compact">
                        ...
                        <div class="row align-items-center mb-2">
                            <div class="col-12 col-sm-4 col-lg-3"><label class="form-label">Costo directo</label></div>
                            <div class="col-12 col-sm-8 col-lg-9"><input class="form-control" name="costo_directo" placeholder="Placeholder"></div>
                        </div>
