{{-- resources/views/materiales.blade.php --}}
    <!doctype html>
<html lang="es">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Materiales | App Precios Unitarios</title>
    ...
    <div class="app-main">
        ...
        <main class="content-area">
            <div class="content-wrap">
                <div class="sheet">
                    <div class="mb-3 fw-semibold">Materiales</div>
                    ...
                    <form method="POST" action="#" class="form-compact">
                        ...
                        <div class="row align-items-center mb-2">
                            <div class="col-12 col-sm-4 col-lg-3"><label class="form-label">Materiales</label></div>
                            <div class="col-12 col-sm-8 col-lg-9"><input class="form-control" name="material" placeholder="Placeholder"></div>
                        </div>
                        <div class="row align-items-center mb-2">
                            <div class="col-12 col-sm-4 col-lg-3"><label class="form-label">Marca</label></div>
                            <div class="col-12 col-sm-8 col-lg-9"><input class="form-control" name="marca" placeholder="Placeholder"></div>
                        </div>
                        <div class="row align-items-center mb-2">
                        ...
                        <div class="row align-items-center mb-3">
                            <div class="col-12 col-sm-4 col-lg-3"><label class="form-label">Precios</label></div>
                            <div class="col-12 col-sm-8 col-lg-9"><input class="form-control" name="precio" placeholder="Placeholder"></div>
                        </div>
