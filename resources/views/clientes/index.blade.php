    ...
    <div class="index-panel">
        <div class="header-section">
            ...
            <div class="header-actions">
                <a href="{{ route('clientes.create') }}" class="btn-add-new"><i class="bi bi-plus-circle me-1"></i> Nuevo Cliente</a>
            </div>
        </div>
                ...
                @forelse($clientes as $cliente)
                    <tr class="project-row">
                        ...
                        <td class="action-cell">
                            <a href="{{ route('clientes.show', $cliente) }}" class="btn-icon-action"><i class="bi bi-eye"></i></a>
                            <a href="{{ route('clientes.edit', $cliente) }}" class="btn-icon-action"><i class="bi bi-pencil-square"></i></a>
                            <form action="{{ route('clientes.destroy', $cliente) }}" method="POST" style="display:inline;" onsubmit="return confirm('¿Eliminar cliente?');">
                                @csrf @method('DELETE')
