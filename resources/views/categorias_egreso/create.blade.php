@extends('layout')
@section('title','Nueva Categoría de Egreso')
@section('content')
...
<div class="dash-form-view">
    ...
    <div class="form-panel">
        <div class="header-section"><h1>Nueva Categoría</h1></div>
        <form action="{{ route('categorias_egreso.store') }}" method="POST">
            @csrf
            <div class="form-group">
                <label for="nombre">Nombre *</label>
                <input type="text" id="nombre" name="nombre" class="form-control" value="{{ old('nombre') }}" required maxlength="100">
