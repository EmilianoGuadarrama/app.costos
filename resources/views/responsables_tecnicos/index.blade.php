...
<div class="dash-index-view">
    <div class="index-panel">
        <div class="header-section">
            <div><h1>Responsables Técnicos</h1></div>
            <div class="header-actions">
                <a href="{{ route('responsables_tecnicos.create') }}" class="btn-add-new"><i class="bi bi-plus-circle me-1"></i> Nuevo Responsable</a>
            </div>
        </div>
                ...
                @forelse($responsables as $responsable)
                    <tr class="project-row">
                        ...
                        <td class="action-cell">
                            <a href="{{ route('responsables_tecnicos.show', $responsable) }}" class="btn-icon-action"><i class="bi bi-eye"></i></a>
                            <a href="{{ route('responsables_tecnicos.edit', $responsable) }}" class="btn-icon-action"><i class="bi bi-pencil-square"></i></a>
                            <form action="{{ route('responsables_tecnicos.destroy', $responsable) }}" method="POST" style="display:inline;" onsubmit="return confirm('¿Eliminar responsable técnico?');">
                                @csrf @method('DELETE')
