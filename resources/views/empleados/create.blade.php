        ...
        <form action="{{ route('empleados.store') }}" method="POST">
            ...
            <div class="f-grid">
                <div>
                    ...
                    <input type="text" name="nombre" class="f-ctrl" value="{{ old('nombre') }}" required>
                </div>
                <div>
                    <label class="f-lbl">Apellidos</label>
                    <input type="text" name="apellido_paterno" class="f-ctrl" value="{{ old('apellido_paterno') }}">
                </div>
            </div>
            ...
            <div class="f-grid">
                <div>
                    ...
                    <input type="text" name="rol" class="f-ctrl" value="{{ old('rol') }}" placeholder="Ej. Residente, Auxiliar...">
                </div>
                <div>
                    <label class="f-lbl">Salario Base ($)</label>
                    <input type="number" step="0.01" name="salario_base" class="f-ctrl" value="{{ old('salario_base') }}" placeholder="0.00">
                </div>
            </div>
            ...
            <div class="f-grid">
                <div>
                    ...
                    <input type="text" name="telefono_1" class="f-ctrl" value="{{ old('telefono_1') }}">
                </div>
                <div>
                    <label class="f-lbl">Email</label>
                    <input type="email" name="email" class="f-ctrl" value="{{ old('email') }}">
                </div>
            </div>
