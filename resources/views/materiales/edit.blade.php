...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
        <div>
            <h4 class="fw-bold mb-1">Editar Material</h4>
            <div class="text-secondary small">Vista demo para edición.</div>
        </div>
        <a href="{{ route('materiales') }}" class="btn btn-sm btn-outline-secondary">
    ...
    <div class="panel-box">
        <div class="form-grid">
            @php $fields = ['Clave','Materiales','Marca','Unidad','Precios']; @endphp
            @foreach($fields as $f)
