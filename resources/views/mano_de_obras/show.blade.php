...
@section('content')
    ...
    @php
        $campos = [
            ['label' => 'Clave', 'value' => $mano->clave ?? 'MO-001'],
            ['label' => 'Categoría', 'value' => $mano->categoria ?? 'Oficial'],
            ['label' => 'Unidad', 'value' => $mano->unidad ?? 'Jor'],
            ['label' => 'Salario', 'value' => $mano->salario ?? '500.00'],
        ];
    @endphp

    <div class="page-header">
        <div>
            <h2 class="page-title">Detalle de Mano de Obra</h2>
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ Route::has('mano_obra.edit') ? route('mano_obra.edit', $mano->id ?? 1) : '#' }}" class="btn btn-edit">
