...
<div class="dash-form-view">
    ...
    <div class="form-panel">
        <div class="header-section"><h1>Nueva Maquinaria/Equipo</h1></div>
        <form action="{{ route('maquinaria_equipo.store') }}" method="POST">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" id="equipo" name="equipo" class="form-control" value="{{ old('equipo') }}" required maxlength="150">
            ...
            <div class="form-group">
                ...
                <input type="number" step="0.01" id="costo_por_hora" name="costo_por_hora" class="form-control" value="{{ old('costo_por_hora', 0) }}" required>
