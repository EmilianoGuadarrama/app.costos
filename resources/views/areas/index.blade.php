                    ...
                    @forelse($areas as $area)
                        ...
                        <tr class="project-row">
                            ...
                            <td class="action-cell">
                                ...
                                <button type="button" class="btn-icon-action" title="Eliminar" data-bs-toggle="modal" data-bs-target="#eliminarAreaModal{{ $areaId }}">
                        ...
                        <!-- Modal Ver -->
                        <div class="modal fade" id="verAreaModal{{ $areaId }}" tabindex="-1" aria-labelledby="verAreaModalLabel{{ $areaId }}" aria-hidden="true">
                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="verAreaModalLabel{{ $areaId }}">
                                            {{ $area->nombre }}
                                        </h5>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="{{ route('areas.edit', $areaId) }}" class="btn-modal-dark">Editar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Modal Eliminar -->
                        <div class="modal fade" id="eliminarAreaModal{{ $areaId }}" tabindex="-1" aria-labelledby="eliminarAreaModalLabel{{ $areaId }}" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="eliminarAreaModalLabel{{ $areaId }}">Eliminar área</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                                    </div>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <form action="{{ route('areas.destroy', $areaId) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
