...
<div class="dash-form-view">
    ...
    <div class="form-panel">
        <div class="header-section"><h1>Nueva Maquinaria</h1></div>
        <form action="{{ route('maquinaria.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <textarea id="descripcion" name="descripcion" class="form-control" rows="2" maxlength="255">{{ old('descripcion') }}</textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" step="0.01" min="0" id="precio_x_unidad" name="precio_x_unidad" class="form-control" value="{{ old('precio_x_unidad', 0) }}" required>
                @error('precio_x_unidad') <span class="text-danger">{{ $message }}</span> @enderror
            </div>
            <button type="submit" class="btn-submit"><i class="bi bi-save me-1"></i> Guardar</button>
        </form>
    </div>
</div>
@endsection
