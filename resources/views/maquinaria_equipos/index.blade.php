...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ Route::has('maquinaria_equipo.create') ? route('maquinaria_equipo.create') : '#' }}" class="btn btn-sm btn-secondary">
        ...
        <table class="tbl-grid">
            ...
            @forelse(($maquinarias ?? []) as $maquinaria)
                <tr>
                    ...
                    <td>
                        <div class="actions">
                            <a class="icon-btn" href="{{ Route::has('maquinaria_equipo.edit') ? route('maquinaria_equipo.edit', $maquinaria->id ?? 1) : '#' }}" title="Editar">
            ...
            @empty
                @for($i = 0; $i < 6; $i++)
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="actions">
                                <a class="icon-btn" href="{{ Route::has('maquinaria_equipo.edit') ? route('maquinaria_equipo.edit', $id) : '#' }}" title="Editar">
                                    <i class="bi bi-pencil"></i>
                                </a>
                                <button class="icon-btn" type="button" title="Eliminar">
                                    <i class="bi bi-trash"></i>
