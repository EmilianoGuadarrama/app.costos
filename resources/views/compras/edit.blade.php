...
<div class="dash-form-view">
    ...
    <div class="form-panel">
        <div class="header-section"><h1>Editar Compra</h1></div>
        <form action="{{ route('compras.update', $compra) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <select id="proyecto_id" name="proyecto_id" class="form-select" required>
                    ...
                    @foreach($proyectos as $p)
                        <option value="{{ $p->id }}" {{ old('proyecto_id', $compra->proyecto_id) == $p->id ? 'selected' : '' }}>{{ $p->nombre }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select id="area_id" name="area_id" class="form-select" required>
                    ...
                    @foreach($areas as $a)
                        <option value="{{ $a->id }}" {{ old('area_id', $compra->area_id) == $a->id ? 'selected' : '' }}>{{ $a->nombre }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input type="date" id="fecha_compra" name="fecha_compra" class="form-control" value="{{ old('fecha_compra', \Carbon\Carbon::parse($compra->fecha_compra)->format('Y-m-d')) }}" required>
            ...
            <div class="form-group">
                ...
                <input type="text" id="factura" name="factura" class="form-control" value="{{ old('factura', $compra->factura) }}" maxlength="100">
