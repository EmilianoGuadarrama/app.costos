    ...
    <div class="index-panel">
        <div class="header-section">
            ...
            <div class="header-actions">
                <a href="{{ route('empresas.create') }}" class="btn-add-new"><i class="bi bi-plus-circle me-1"></i> Nueva Empresa</a>
            </div>
        </div>
        <div class="table-responsive">
            <table class="project-table">
                <thead><tr><th>Nombre</th><th>Dirección</th><th>Logo Path</th><th style="text-align:right;">Acciones</th></tr></thead>
                <tbody>
                @forelse($empresas as $empresa)
                    <tr class="project-row">
                        ...
                        <td class="action-cell">
                            <a href="{{ route('empresas.show', $empresa) }}" class="btn-icon-action"><i class="bi bi-eye"></i></a>
                            <a href="{{ route('empresas.edit', $empresa) }}" class="btn-icon-action"><i class="bi bi-pencil-square"></i></a>
                            <form action="{{ route('empresas.destroy', $empresa) }}" method="POST" style="display:inline;" onsubmit="return confirm('¿Eliminar empresa?');">
                                @csrf @method('DELETE')
