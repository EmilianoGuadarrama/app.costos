...
<div class="dash-index-view">
    <div class="index-panel">
        ...
        <div class="header-section">
            <div><h1>Ingresos</h1><p>Registro y control de ingresos por proyecto y cliente.</p></div>
            <div class="header-actions"><a href="{{ route('ingresos.create') }}" class="btn-add-new"><i class="bi bi-plus-circle me-1"></i> Nuevo Ingreso</a></div>
        </div>
                    ...
                    <tbody style="border-top: 2px solid #eaeaea;">
                        <tr style="background:#f9f9f9; cursor:pointer;" data-bs-toggle="collapse" data-bs-target="#collapse-{{ $mesId }}">
                            ...
                            <td class="text-end" style="white-space:nowrap;">
                                <a href="{{ route('ingresos.pdf_mes', [$anioRef, $mesRef]) }}"
