@extends('layout')
@section('title','Editar Estado de Proyecto')
@section('content')
...
<div class="dash-form-view">
    ...
    <div class="form-panel">
        <div class="header-section"><h1>Editar Estado</h1></div>
        <form action="{{ route('estados_proyecto.update', $estado) }}" method="POST">
            @csrf @method('PUT')
            <div class="form-group">
                <label for="nombre">Nombre *</label>
                <input type="text" id="nombre" name="nombre" class="form-control" value="{{ old('nombre', $estado->nombre) }}" required maxlength="60">
