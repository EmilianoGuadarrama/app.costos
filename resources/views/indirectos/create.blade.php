...
@section('content')
    ...
    <div class="page-header">
        <div>
            <h2 class="page-title">Nuevo Indirecto</h2>
            <p class="page-subtitle">Captura la información general del costo indirecto.</p>
        </div>
    ...
    <div class="form-card">
        <form action="{{ Route::has('indirectos.store') ? route('indirectos.store') : '#' }}" method="POST" class="form-grid">
            @csrf
            ...
            <div class="d-flex justify-content-end gap-2 mt-4">
                ...
                <button type="submit" class="btn btn-save">
                    <i class="bi bi-plus-circle me-2"></i> Guardar Indirecto
                </button>
            </div>
        </form>
    </div>
