    ...
    <div class="dash-index-view">
        <div class="index-panel">
            <div class="header-section">
                <div>
                    <h1>Generadores</h1>
                    <p>Listado de generadores, medidas y resultados de cálculo.</p>
                </div>
                ...
                <div class="header-actions">
                    ...
                    <a href="{{ Route::has('generadores.create') ? route('generadores.create') : '#' }}" class="btn-add-new">
            ...
            <div class="table-responsive">
                <table class="project-table">
                    ...
                    @empty
                        <tr class="project-row">
                            <td colspan="4" class="empty-state">No hay generadores registrados por el momento.</td>
                        </tr>
                    @endforelse
                    </tbody>
                </table>
