...
<div class="dash-form-view">
    ...
    <div class="form-panel">
        <div class="header-section"><h1>Nueva Mano de Obra</h1></div>
        <form action="{{ route('mano_obra.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="categoria" name="categoria" class="form-control" value="{{ old('categoria') }}" required maxlength="150">
            ...
            <div class="form-group">
                ...
                <input type="number" step="0.01" id="salario_unitario" name="salario_unitario" class="form-control" value="{{ old('salario_unitario', 0) }}" required>
