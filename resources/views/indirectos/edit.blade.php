...
<div class="dash-form-view">
    ...
    <div class="form-panel">
        <div class="header-section">
            <h1>Editar Indirecto</h1>
            <p>Actualiza el concepto, porcentaje o descripción del indirecto seleccionado.</p>
        </div>
        ...
        <form action="{{ route('indirectos.update', $indirecto->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    value="{{ old('concepto', $indirecto->concepto) }}"
                    required
                    maxlength="200"
                >
                @error('concepto')
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    value="{{ old('porcentaje', $indirecto->porcentaje) }}"
                    required
                >
                @error('porcentaje')
                    <span class="text-danger">{{ $message }}</span>
            ...
            <div class="form-group">
                ...
                <textarea
                    ...
                    rows="4"
                    maxlength="255"
                >{{ old('descripcion', $indirecto->descripcion) }}</textarea>
                @error('descripcion')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="btn-actions">
                <button type="submit" class="btn-submit">
                    <i class="bi bi-save me-2"></i>Actualizar Indirecto
                </button>
