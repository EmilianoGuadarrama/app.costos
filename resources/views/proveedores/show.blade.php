...
<div class="dash-form-view">
    ...
    <div class="form-panel">
        <div class="header-section">
            ...
            <a href="{{ route('proveedores.edit', $proveedore) }}" class="btn btn-sm btn-outline-dark"><i class="bi bi-pencil"></i> Editar</a>
        </div>
        <div class="detail-row"><div class="detail-label">Nombre</div><div class="detail-value">{{ $proveedore->nombre }}</div></div>
        <div class="detail-row"><div class="detail-label">Contacto</div><div class="detail-value">{{ $proveedore->contacto ?? '—' }}</div></div>
        <div class="detail-row"><div class="detail-label">Teléfono</div><div class="detail-value">{{ $proveedore->telefono ?? '—' }}</div></div>
        <div class="detail-row"><div class="detail-label">Correo</div><div class="detail-value">{{ $proveedore->correo ?? '—' }}</div></div>
        <div class="detail-row"><div class="detail-label">Dirección</div><div class="detail-value">{{ $proveedore->direccion ?? '—' }}</div></div>
        <div class="detail-row"><div class="detail-label">Tipo</div><div class="detail-value">{{ $proveedore->tipo ?? '—' }}</div></div>
        <div class="detail-row"><div class="detail-label">Creado</div><div class="detail-value">{{ $proveedore->created_at?->format('d/m/Y H:i') ?? '—' }}</div></div>
    </div>
</div>
@endsection
