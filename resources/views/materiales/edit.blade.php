...
<div class="dash-form-view">
    ...
    <div class="form-panel">
        <div class="header-section"><h1>Editar Material</h1></div>
        <form action="{{ route('materiales.update', $material) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="nombre" name="nombre" class="form-control" value="{{ old('nombre', $material->nombre) }}" required maxlength="150">
            ...
            <div class="form-group">
                ...
                <select id="unidad_medida_id" name="unidad_medida_id" class="form-select" required>
                    ...
                    @foreach($unidades as $u)
                        <option value="{{ $u->id }}" {{ old('unidad_medida_id', $material->unidad_medida_id) == $u->id ? 'selected' : '' }}>{{ $u->nombre }} ({{ $u->abreviatura }})</option>
                    @endforeach
                </select>
