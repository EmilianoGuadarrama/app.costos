{{-- resources/views/maquinaria_equipo.blade.php --}}
    <!doctype html>
<html lang="es">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Maquinaria y Equipo | App Precios Unitarios</title>
    ...
    <style>
        ...
        .brand-badge{ width:44px;height:44px;border-radius:50%; background:#fff; display:grid; place-items:center; position:relative; overflow:hidden; }
        .brand-badge .bolt{ position:absolute; right:-2px; top:-2px; width:18px; height:18px; border-radius:4px; background:#2bd15a; display:grid; place-items:center; color:#fff; font-size:.85rem; }
        .topbar .welcome{ color:#fff; opacity:.9; font-size:.95rem; }

        .sidebar{ width:270px; background:var(--ui-dark); color:#fff; border-right:1px solid rgba(255,255,255,.15); }
        .sidebar-inner{ padding:14px 14px 18px; }
        .search{ background:#fff; border-radius:999px; padding:4px 10px; }
        .nav-vertical .list-group-item{ background:transparent; border:0; color:#fff; padding:.55rem .75rem; border-radius:.35rem; display:flex; align-items:center; gap:.6rem; }
        ...
        .sheet{ border:1px solid rgba(0,0,0,.15); border-radius:4px; padding:26px 30px; background:#fff; }

        .form-compact .form-label{ margin-bottom:0; font-size:.9rem; color:#222; }
        .form-compact .form-control{ font-size:.82rem; padding:.2rem .45rem; height:22px; border-radius:2px; max-width:230px; }
        .form-compact .row{ --bs-gutter-x: 14px; }
        .form-compact .mb-2{ margin-bottom:.55rem !important; }

        .table thead th{ font-size:.74rem; vertical-align:middle; }
...
<div class="app-shell">
    ...
    <nav class="navbar navbar-expand-lg topbar py-2">
        <div class="container-fluid px-3">
            ...
            <div class="d-none d-md-block welcome text-center flex-grow-1">“Bienvenido a app.precios.unitarios.”</div>

            <div class="d-flex align-items-center gap-2">
                <button class="btn btn-sm btn-outline-light d-lg-none" data-bs-toggle="offcanvas" data-bs-target="#sidebarOffcanvas"><i class="bi bi-list"></i></button>
                <div class="d-flex align-items-center gap-2 text-white">
                    <i class="bi bi-person-circle fs-4"></i><span class="small">Usuario Activo</span>
                </div>
            </div>
        </div>
    </nav>
    ...
    <div class="app-main">
        ...
        <main class="content-area">
            <div class="content-wrap">
                <div class="sheet">
                    <div class="mb-3 fw-semibold">Maquinaria y Equipo</div>
                    ...
                    <form method="POST" action="#" class="form-compact">
                        ...
                        <div class="row align-items-center mb-2">
                            <div class="col-12 col-sm-4 col-lg-3"><label class="form-label">Equipo</label></div>
                            <div class="col-12 col-sm-8 col-lg-9"><input class="form-control" name="equipo" placeholder="Placeholder"></div>
                        </div>
                        <div class="row align-items-center mb-2">
                        ...
                        <div class="row align-items-center mb-3">
                            <div class="col-12 col-sm-4 col-lg-3"><label class="form-label">Costo por hora</label></div>
                            <div class="col-12 col-sm-8 col-lg-9"><input class="form-control" name="costo_hora" placeholder="Placeholder"></div>
                        </div>
                                ...
                                @for($i=0; $i<4; $i++)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button type="button" class="btn btn-outline-dark btn-sm btn-action me-1" title="Editar"><i class="bi bi-pencil-fill"></i></button>
                                            <button type="button" class="btn btn-outline-dark btn-sm btn-action" title="Eliminar"><i class="bi bi-trash-fill"></i></button>
                                        </td>
                                    </tr>
                                @endfor
                                </tbody>
            ...
            <div class="row g-4 align-items-start">
                ...
                <div class="col-12 col-md-4">
                    ...
                    <div class="small muted">
                        <div class="d-flex justify-content-between border-bottom border-light border-opacity-25 py-1"><span>Teléfono</span><span>— — — —</span></div>
                        <div class="d-flex justify-content-between border-bottom border-light border-opacity-25 py-1"><span>Correo</span><span>— — — —</span></div>
                    </div>

                    <div class="d-flex gap-2 mt-3">
                        <a class="btn btn-outline-light btn-sm rounded-circle" style="width:40px;height:40px;display:grid;place-items:center;" href="#"><i class="bi bi-instagram"></i></a>
                        <a class="btn btn-outline-light btn-sm rounded-circle" style="width:40px;height:40px;display:grid;place-items:center;" href="#"><i class="bi bi-facebook"></i></a>
                        <a class="btn btn-outline-light btn-sm rounded-circle" style="width:40px;height:40px;display:grid;place-items:center;" href="#"><i class="bi bi-lightning-fill"></i></a>
                    </div>
                </div>
            </div>
        </div>
